...
from data_reader import getVoxelDataset # LigandDataset
import h5py
...
if __name__ == '__main__':
    ...
    train_data = getVoxelDataset(args.train_set, vol_dim=64)
    ...
    val_data = getVoxelDataset(args.val_set, vol_dim=64)
